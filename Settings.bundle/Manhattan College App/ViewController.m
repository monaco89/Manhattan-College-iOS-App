...
-(IBAction)twitter
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://twitter.com/MCStudentEngage"]];
}
...
-(IBAction)more
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://inside.manhattan.edu"]];
}
